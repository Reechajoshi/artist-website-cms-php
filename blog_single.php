<?php
	...
	if(isset($_GET['name']))
	{
		...
		$blog_name = $_GET['name'];
		$curr_blog_idx = array_search( $blog_name, $blog_nav_array );
		$blog_count = count( $blog_nav_array );
	...
	echo('<html><head>
		...
		<div class="paging paging1"><a href="blog_single.php?name='.( ( $curr_blog_idx == 0 ) ? ( $blog_nav_array[ ( $blog_count - 1 ) ] ) : ( $blog_nav_array[ ( $curr_blog_idx - 1 ) ] ) ).'" class="jp-previous jp-disabled">← Previous</a>
		<a href="blog_single.php?name=benny_dayal_blog" '.( ( $curr_blog_idx == 0 ) ? ( 'class="jp-current"' ) : ( '' ) ).'>1</a>
		<a href="blog_single.php?name=mizhikalil_blog" '.( ( $curr_blog_idx == 1 ) ? ( 'class="jp-current"' ) : ( '' ) ).'>2</a>
		<a href="blog_single.php?name=neela_mizhi_blog" '.( ( $curr_blog_idx == 2 ) ? ( 'class="jp-current"' ) : ( '' ) ).'>3</a>
		<a href="blog_single.php?name=azhage_va_blog" '.( ( $curr_blog_idx == 3 ) ? ( 'class="jp-current"' ) : ( '' ) ).'>4</a>
		<a href="blog_single.php?name='.( ( $curr_blog_idx == ( $blog_count - 1 ) ) ? ( $blog_nav_array[ 0 ] ) : ( $blog_nav_array[ ( $curr_blog_idx + 1 ) ] ) ).'" class="jp-next jp-disabled">Next →</a></div>
